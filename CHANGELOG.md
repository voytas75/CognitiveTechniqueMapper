...
- Made `create_search_service` and `create_catalog_service` use explicit dependency factories rather than resolving their dependencies through mutable `src.cli` compatibility exports.
